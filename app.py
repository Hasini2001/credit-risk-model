...
encode ={col : joblib.load(f"{col}_encoder.pkl") for col in ["Sex", "Education",  "Saving accounts", "Checking accounts"]}
...
credit_amount = st.number_input("Credit Amount", min_value=0, value=1000.0)
